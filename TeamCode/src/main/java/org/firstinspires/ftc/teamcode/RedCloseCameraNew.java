...
@Autonomous (name="CamAutoNew")
public class RedCloseCameraNew extends LinearOpMode {
    ...
    public void getPosition() {
        ...
        if (currentRecognitions.size() > 0) {
            Recognition recognized = currentRecognitions.get(0);

            if (recognized.getConfidence() >= 0.9) {
                leftMovements();
            }
        }
